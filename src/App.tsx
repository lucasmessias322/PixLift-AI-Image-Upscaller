...
// function App() {
//   const [selectedModel, setSelectedModel] = useState<string>("esrgan-x4");
...
//   // Após converter cada imagem, ela é removida da lista de pendentes
//   // e adicionada à lista de imagens convertidas.
...
//           <ConvertedGallery>
//             <h2>Imagens Convertidas</h2>
//             <ImageConvertedContainer>
//               {convertedImages.map((item, index) => (
//                 <ImageConvertedWrapper key={index}>
//                   <ImageConverted src={item.enhancedPath} />
...
//       />
//       <ComparisonPopUp>
//         <ImageComparison originalSrc="" enhancedSrc="" />
//       </ComparisonPopUp>
//     </Container>
//   );
// }
